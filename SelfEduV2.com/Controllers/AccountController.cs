...
namespace SelfEduV2.com.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            string username;
            try {
                //the point of the try catch is if the user passes in an invalid email then
                //a FormatException is thrown the in the catch we will check if it is a username
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, DateOfBirth = model.DateOfBirth, PhoneNumber = model.PhoneNumber };
